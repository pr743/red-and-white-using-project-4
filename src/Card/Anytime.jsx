...
const anytime = [
  ...
  {
    img: "https://cloudassets.starbucks.com/is/image/sbuxcorp/WalMartValueAddFY26",
    link: "https://www.starbucks.com/gift/00001106",
  },
  {
    img: "https://cloudassets.starbucks.com/is/image/sbuxcorp/HolidayPoinsettiaFY26",
    link: "https://www.starbucks.com/gift/00001074",
  },
  {
    img: "https://globalassets.starbucks.com/digitalassets/cards/fy23/HeritageMultipackFY23.jpg",
    link: "https://www.starbucks.com/gift/00000035",
  },
];
...
function Anytime() {
  ...
  const maxIndex = anytime.length - items; 
        ...
        <div className="relative w-full overflow-hidden ">
          ...
          >
            {anytime.map((item, i) => (
              <div
                key={i}
                className="flex-shrink-0 w-[80%] sm:w-[90%] mx-1" 
              >
                <a href={item.link}>
